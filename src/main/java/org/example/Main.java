...
//Наследование и полиморфизм ст 189. Задачи переходи к третьему разделу ст 18, иди писать следующий класс пользуйся публичными переменными не копипасти все методы
